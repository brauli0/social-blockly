...
public class UserController {
	...
	public UserDto saveLastLoginDate(@RequestAttribute Long userId) throws InstanceNotFoundException {
		return toUserDto(userService.saveLastLoginDate(userId));
	}
	...
	public UserDto getUserInfo(@PathVariable Long id)
		...
		return toUserDto(userService.getUserInfo(id));

	}

	@GetMapping("/publicinfo/{username}")
	public UserDto getUserPublicInfo(@PathVariable String username) throws InstanceNotFoundException {
		return toUserDto(userService.getUserInfo(username));
	}

	@GetMapping("/search/{keyword}")
	public List<UserDto> getUsersByKeyword(@PathVariable String keyword) {
		return toUserDtos(userService.getUsersByKeyword(keyword));
	}
