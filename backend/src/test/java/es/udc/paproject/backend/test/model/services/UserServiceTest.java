...
public class UserServiceTest {
	...
	public void testSignUpAndLoginFromId() throws DuplicateInstanceException, InstanceNotFoundException {
		...
		assertEquals(User.RoleType.STUDENT, user.getRole());
	...
	@Test
	public void testSearchUsersByKeyword() throws DuplicateInstanceException {
		User user1 = createUser("pepito");
		userService.signUp(user1);
		User user2 = createUser("pepita");
		userService.signUp(user2);

		List<User> users = userService.getUsersByKeyword("pepit");
